...
var meses int
// Loop para calcular o número de meses necessários
...
f.Printf("Serão necessários %d meses para que o salário de João iguale ou ultrapasse o salário de Carlos.", meses)
}